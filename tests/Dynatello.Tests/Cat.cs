...
[DynamoDBMarshaller(
    AccessName = "QueryWithCuteness",
    ArgumentType = typeof((Guid Id, double MinimumCuteness))
)]
[DynamoDBMarshaller(
    AccessName = "GetByCompositeKey",
    ArgumentType = typeof((Guid Id, Guid HomeId))
)]
...
[DynamoDBMarshaller(
    AccessName = "GetByCompositeInvalidPartition",
    ArgumentType = typeof((string Id, Guid HomeId))
)]
[DynamoDBMarshaller(
    AccessName = "GetByCompositeInvalidRange",
    ArgumentType = typeof((Guid Id, string HomeId))
)]
[DynamoDBMarshaller(
    AccessName = "GetByCompositeInvalidPartitionAndRange",
